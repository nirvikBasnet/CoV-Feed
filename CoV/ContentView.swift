...
//  CoV
//
//  Created by Nirvik Basnet on 6/3/20.
...
class getData : ObservableObject{
    ...
    init() {
        let source = "http://newsapi.org/v2/top-headlines?language=en&q=coronavirus&from=2020-02-06&sortBy=publishedAt&apiKey=putyourkeyhere"
